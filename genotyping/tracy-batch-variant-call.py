...
def abi_trim(ab1_file_path):
    ...
    return left_trim, right_trim, len(untrimmed), len(trimmed)
...
def main() -> None:
    ...
    for sample in list_of_samples:
        ...
        if best_run:
            ...
            run_date = name_components[3]
            left_trim, right_trim, untrim_len, trim_len = abi_trim(best_run)
            best_run_samples.append((run.name, sample_name, primer_name, run_date, best_trace, best_pup, left_trim, right_trim, untrim_len, trim_len))
